...
label start:
    ...
    e "이제 이세계는 전쟁이란 개념은 완전히 사라졌습니다. 예전이였으면 군인 로봇으로 대려갔을수도 있지만 요즘에는 시대가 달라졌어요! 제가 만든 프로그램 없으면 그냥 고철덩어리 밖에 못해요! "
...
label iphaksik
    ...
    g "으아아아"
    "많은 시간이 흐른 뒤"
    p "이것으로 순살대학교 입학식을 마치겠습니다."
    g "휴...하마터면 큰일날뻔했네"
    p "이제 학생들은 각자 신청한 과 교실에서 안내받으시면 되겠습니다."
    menu:
        "물리학과":
        ...
        "생물학과":
            ...
            sm "너 이름이 뭐야."
            g "강세진 입니다."
            sm "... " #폰을 보면서 #이 생물학쌤이 가장 매력적인 캐릭터이면 좋겠음 물론 출연은 여기서 밖에 안함(젊음)
            sm "니이름 없는데? 너 물리학과야."
            g "에?"
            sm "빨리 달려가라."
            g "으아아아 늦었다아아"
